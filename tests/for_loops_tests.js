...
describe("returnEvenOddMessage", function() {
    ...
    it("should return a string when passed an integer", function() {
        ...
        expect(typeof returnEvenOddMessage(getRandomInt(1, 100))).toBe('function')
    });
    it("should return the correct message when passed an integer", function() {
        ...
        expect(typeof returnEvenOddMessage(3)).toBe('3 is odd')
        expect(typeof returnEvenOddMessage(4)).toBe('4 is even')
        expect(typeof returnEvenOddMessage("Hello")).toBe('Hello is invalid')
    });
});
...
describe('countdDownByFive, function() {
    it('countDownByFivess should be a defined function'), function ()
    expect(typeof countDownByFives).toBe('function)')
{
    it('countDownByFivess should be a defined function'), function ()
    expect(typeof countDownByFives).toBe('function)')
};
